...
bot = telebot.TeleBot('7514216182:AAHJ1MjqUipwu8i__et7V3FPNcoXZQ5NT5c')
...
#  Join Official Channel @MAHAKALXGAME
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @MAHAKALXGAME."
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @MAHAKALXGAME ."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, port, and time
            ...
            if time > 240:
                response = "Error: Buy From @MAHAKALXGAME For More Time"
            else:
...
Buy From :- @MAHAKALXGAME
Official Channel :- https://t.me/MAHAKALXGAME12
'''
...
3. MAKE SURE YOU JOINED https://t.me/MAHAKALXGAME12 OTHERWISE NOT WORK
